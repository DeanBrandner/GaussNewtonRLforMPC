...
if __name__ == "__main__":
    ...
    for idx in range(n_initial_guesses_for_rl_params):
        ...
        if use_momentum:
            ...
            momentum_type = "Adam"
        agent_path = os.path.join("CSTR", "data", "ic_investigation", f"GA_{momentum_type}", f"lr{actor_learning_rate:.1e}_nIC{n_episodes_per_replay}_beta_1_{beta_1:.2f}_beta_2_{beta_2:.3f}", f"initial_guess_{idx}")
