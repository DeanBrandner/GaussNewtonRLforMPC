...
def get_rl_mpc():
    ...
    mpc.set_nl_cons(expr_name = "C_a_lower", expr = 0.1 - C_a, ub = 0.0, soft_constraint = True, penalty_term_cons=1e2)
    mpc.set_nl_cons(expr_name = "C_a_upper", expr = C_a - 2.0, ub = 0.0, soft_constraint = True, penalty_term_cons=1e2)
    mpc.set_nl_cons(expr_name = "C_b_lower", expr = 0.1 - C_b, ub = 0.0, soft_constraint = True, penalty_term_cons=1e2)
    mpc.set_nl_cons(expr_name = "C_b_upper", expr = C_b - 2.0, ub = 0.0, soft_constraint = True, penalty_term_cons=1e2)
    mpc.set_nl_cons(expr_name = "T_R_lower", expr = 80 - T_R, ub = 0.0, soft_constraint = True, penalty_term_cons=100.0)
    mpc.set_nl_cons(expr_name = "T_R_upper", expr = T_R - 140.0, ub = 0.0, soft_constraint = True, penalty_term_cons=100.0)
    mpc.set_nl_cons(expr_name = "T_K_lower", expr = 80 - T_K, ub = 0.0, soft_constraint = True, penalty_term_cons=100.0)
    mpc.set_nl_cons(expr_name = "T_K_upper", expr = T_K - 140.0, ub = 0.0, soft_constraint = True, penalty_term_cons=100.0)
    ...
    R = 1e-2 * cd.diag([0.1, 0.1])  # Regularization matrix for the control input
