...
if __name__ == "__main__":
    ...
    for momentum_beta in momentum_beta_list:
        for momentum_eta in momentum_eta_list:
            for omega in omega_list:
                ...
                agent_path = os.path.join("CSTR", "data", "approx_newton", f"lr{actor_learning_rate:.1e}_nIC{n_episodes_per_replay}_beta{momentum_beta:.2f}_eta{momentum_eta:.3f}_omegainv{omegainv:.1e}")
