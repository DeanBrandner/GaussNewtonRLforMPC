...
if __name__ == "__main__":
    ...
    for idx in range(n_initial_guesses_for_rl_params):
        agent_path = os.path.join("CSTR", "data", "ic_investigation", f"gauss_newton", f"lr{actor_learning_rate:.1e}_nIC{n_episodes_per_replay}_beta_{beta:.2f}_eta_{eta:.3f}_omegainv_{omegainv:.1e}", f"initial_guess_{idx}")
